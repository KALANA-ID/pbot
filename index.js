...
const instagram = 'https://instagram.com/cucu.jafin'; // JANGAN UBAH-UBAH INFO!!!
const nomer = 'Wa.me/+6289692581447'; // JANGAN UBAH-UBAH INFO!!!
...
conn.on('qr', qr =>
{
   ...
   console.log(`[ ${moment().format("HH:mm:ss")} ] KALANA ready scan now!`);
});
...
//Tolonglah bro jangan di ubah ubah KALANA
